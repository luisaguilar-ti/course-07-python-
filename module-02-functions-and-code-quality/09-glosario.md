...
Los datos introducidos en una función cuando es llamada.
...
Una nota que los programadores hacen sobre la intención detrás de su código.
...
Una variable que está disponible en todo el programa.

---

## Indentación

Espacio que se añade al principio de una línea de código.
...
Una variable asignada dentro de una función.
...
Una extensa colección de código Python que a menudo viene empaquetada con Python.

---

## Sentencia `return`

Una sentencia Python que se ejecuta dentro de una función y envía información de vuelta a la llamada a la función.
...
Función que los programadores diseñan para sus necesidades específicas.
